...
const workExperience = [
  {
    ...
    duration: '3+ Years',
    responsibilities: [
      'Edited engaging Reels, YouTube videos, promotional videos, and social media content',
      'Worked with Adobe Premiere Pro, After Effects & DaVinci Resolve',
      'Created professional edits using motion graphics, transitions, sound design, captions, and color grading',
      'Collaborated with clients to understand their vision and deliver high-quality videos',
      'Managed complete editing workflows from raw footage to final delivery',
    ],
  },
];
            ...
            {timeline.map((item, index) => (
              ...
              >
                ...
                <div className="glass p-8 rounded-2xl group-hover:border-accent/30 transition-colors">
                  ...
                  <h4 className="text-accent font-mono text-xs uppercase tracking-widest mb-6">
                    {item.company}
                  </h4>
